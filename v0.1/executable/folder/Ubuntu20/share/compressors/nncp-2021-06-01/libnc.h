...
/* complex multiplication of packed complex numbers (real part in even
   indices, imaginary part in odd indices). */
NCTensor *nc_cmul(NCTensor *x1, NCTensor *x2);
/* x1 * conj(x2) */
NCTensor *nc_cmul_conj(NCTensor *x1, NCTensor *x2);
